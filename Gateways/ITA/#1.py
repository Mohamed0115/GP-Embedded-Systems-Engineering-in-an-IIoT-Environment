...
#🔵if user need to send a command  -- I need a file has functions each call a specific command and return the output of it 
#🔵three axis
#🔴🔵full data 1020 not 1024
#🔴🔵calebrate with true value
#UI
 ## which lang.
 ## 

# git fetch origin 
# git branch -a  <clone-pull>
# git branch 
# git checkout <commit>
# git pull 